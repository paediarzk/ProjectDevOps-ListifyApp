package com.example.listify_app.Utils;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String NAME = "taskPlannerDatabase";
        ...
        try {
            ...
            if (cur != null && cur.moveToFirst()) {
                do {
                    ...
                    task.setDescription(cur.getString(cur.getColumnIndexOrThrow(DESCRIPTION)));
                    task.setDate(cur.getString(cur.getColumnIndexOrThrow(DATE)));
                    task.setTime(cur.getString(cur.getColumnIndexOrThrow(TIME)));
